...
import { GridApi, GridReadyEvent, ValueFormatterParams, RowDoubleClickedEvent, ColDef } from 'ag-grid-community';
import { ToastrService } from 'ngx-toastr';
import { HttpCommonService } from '../../Common/http-common.service';
import { EmailGridDto } from 'src/app/Models/EmailGridDto';

@Component({
  selector: 'app-assign-mail-claiming',
  templateUrl: './assign-mail-claiming.component.html',
  styleUrls: ['./assign-mail-claiming.component.css']
})
export class AssignMailClaimingComponent implements OnInit {
